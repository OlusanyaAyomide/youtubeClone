...
export default function Description({data}) {
  ...
  return (
    <div className={`w-full my-6 py-2 ${isDarkMode?"bg-dark-400 text-white":"bg-gray-100"} rounded-lg cont`}>
        ...
        <button className={`absolute rounded-3xl pl-8 ${isDarkMode?"bg-dark-400 text-white":"bg-gray-100"} md:px-3 -bottom-1 outline-none py-1 right-0 md:pl-16 font-semibold`} onClick={
            ()=>{setisfull((prev=>!prev))}
